...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2017 a las 14:14:01
...
CREATE TABLE `canciones` (
  ...
  `caratula` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL
...
INSERT INTO `canciones` (`id`, `idArtista`, `cancion`, `artista`, `album`, `caratula`) VALUES
(1, 2, 'Xpander', 'Sasha', 'Xpander', 'xpander.jpg'),
(2, 3, 'Love Don''t Let Me Go', 'David Guetta', 'Just a Little More Love', 'love.jpg'),
(3, 1, 'Ecuador', 'Sash!', 'It''s My Life – The Album', 'ecuador.jpg'),
(4, 1, 'Adelante', 'Sash!', 'Trilenium', 'adelante.jpg');
