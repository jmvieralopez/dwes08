...
//				Cuando append esta en true, write y append son iguales.
		...
		//CARGAR FORMULARIO
		out.println("<form action='/Visitas-Jesus-Viera-Subida/LibroVisitasSubida' method='post'>Autor: <input type='text' name='autor'></br>Comentario: <br><textarea cols='20' rows='10' name='comentario'></textarea></br><input type='submit' name='enviar' value='Enviar comentario'></form>");
		out.println("<h3>Importar comentarios</h3><form action='/Visitas-Jesus-Viera-Subida/Subir' method='post' enctype='multipart/form-data'> <label>Escoger archivo:</label> <input type='file' name='archivo'><br/> <input type='submit' value='Subir archivo' name='enviar'></form>");
